...
describe('favorite blog', () => {
  test ('when blog list is empty is equal to an empty blog', () => {
    const blogs = []
    const favBlog = {}
    expect(listHelper.favoriteBlog(blogs)).toEqual(favBlog)
  })
  test('when list has only one blog is equal to that blog', () => {
    const blogs = [{
      _id: '5a422a851b54a676234d17f7',
      title: 'React patterns',
      author: 'Michael Chan',
...
describe('author with most blogs ', () => {
  test('when blogs list has many blogs is calculated right', () => {
    const mostBlogs =
    {
      author: 'Robert C. Martin',
      blogs: 3
